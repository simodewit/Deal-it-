...
{
    [SerializeField]
    private SelectableEvents interactionEvents;

    [SerializeField]
    private SelectableSFX interactionSoundEffects;
    ...
    [SerializeField]
    private bool m_deriveFromParentSelectable = false;
    ...
    public AudioSource AudioSource
    {
        get
        {
            if ( m_audioSource == null )
                m_audioSource = transform.root.GetOrAddComponent<AudioSource> ( );
    ...
    private UISelectable[] m_derivedSelectables;
    ...
    public void OnPointerDown ( PointerEventData eventData )
    {
        ...
        if ( DeriveFromParentSelectable && calledFromParent == false )
            return;
        if ( calledFromParent )
